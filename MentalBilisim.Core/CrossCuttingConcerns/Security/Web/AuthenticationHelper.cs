...
namespace MentalBilisim.Core.CrossCuttingConcerns.Security.Web
{
    public class AuthenticationHelper
    {
        ...
        private static string CreatAuthTags(string email, string[] roles, string firstName, string lastName, Guid id)
        {
